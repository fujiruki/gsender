    ...
    return (
        ...
        >
            <path
                ...
                aria-label={t('Jog X plus Y minus')}
            ...
            <path
                ...
                role="button"
                tabIndex={canClick && !isRotaryMode ? 0 : -1}
                aria-label={t('Jog X minus Y minus')}
            ...
            <path
                ...
                role="button"
                tabIndex={canClick && !isRotaryMode ? 0 : -1}
                aria-label={t('Jog X minus Y plus')}
            ...
            <path
                ...
                role="button"
                tabIndex={canClick && !isRotaryMode ? 0 : -1}
                aria-label={t('Jog X plus Y plus')}
