        ...
        <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 max-w-2xl">
                ...
                <ul className="text-left text-gray-700 dark:text-content-primary space-y-2">
                    <li>
                        •{' '}
                        {t('Restart your controller using the power switch')}
                    </li>
                    <li>
                        •{' '}
                        {t(
                            'Ensure the VFD is turned on before restarting the controller',
                        )}
                    </li>
                    <li>
                        •{' '}
                        {t(
                            'Reconnect in gSender and verify your spindle is working as expected.',
                        )}
                    </li>
                </ul>
            </div>
