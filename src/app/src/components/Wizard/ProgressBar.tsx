...
export function ProgressBar({
    ...
    return (
        <div className="bg-white dark:bg-surface-raised border-b border-gray-200 px-8 py-4 flex items-center justify-between">
            ...
            <button
                onClick={onExit}
                className="ml-8 flex items-center gap-2 text-gray-600 dark:text-content-muted hover:text-gray-900 dark:hover:text-gray-100 transition-colors"
            >
                <svg
                    className="w-5 h-5"
                    fill="none"
